...
# -----------------------------------------------------------
# Tidak ada author Untuk Sc ini kecuali ./ReVolt yg Telah Mendesign Dengan Sempurna
# Update 27 November 2020 10:30
# ---------------------------------------------------------------
...
def logo():
	os.system('clear')
	auth=m+'  Author : '+k+'./ReVolt'
	# jika ingin menamambah kan variabel dan mengubah data variabel ReVolt bisa menambahkan %s menambahkan variabel terus di ubah menjjadu string, %d = mengubah data menjadi decimal , %i = mengubah data menjadi integer
	return '''
%s╭━┳━╭━╭━╮%s╮╲╲╲╲╲╲%s╔═╗╔═╗╔═╗╔╦╗
%s┃┈┈┈┣▅╋▅┫┃%s╲╲╲╲╲╲%s╚═╗╠═╝╠═╣║║║
%s┃┈┃┈╰━╰━━━━━━╮%s╲╲%s╚═╝╩  ╩ ╩╩ ╩
